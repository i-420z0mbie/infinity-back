...
export default function Splash() {
  ...
  useEffect(() => {
    Animated.sequence([
      ...
      // Once animations complete, load data then navigate
      loadData();
    });
  }, []);
  ...
  const loadData = async () => {
    try {
      ...
      // 5) navigate to Home with all initial data
      ...
      // On error, still navigate (you can adjust fallback behavior)
      navigation.replace('Home', {
        initialData: {
          properties: [],
          explore: [],
