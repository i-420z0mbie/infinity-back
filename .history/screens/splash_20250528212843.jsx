  ...
  return (
    <View style={styles.container}>
      ...
      {[...Array(15)].map((_, i) => (
        <Animated.View
          key={i}
          style={[styles.particle, { opacity: fadeAnim, transform: [
      ...
      <Animated.View
        style={[styles.logoContainer, { opacity: fadeAnim, transform: [ { scale: Animated.multiply(scaleAnim, pulseAnim) } ], marginBottom: isSmall ? 15 : 25 }]}
      >
      ...
      <Animated.View style={[styles.indicatorContainer, { opacity: fadeAnim }]}>
        <Animated.View style={{ transform: [{ rotate: rotateInterpolate }, { scale: pulseAnim }] }}>
...
const styles = StyleSheet.create({
  ...
  glow: {
    ...
    ...Platform.select({
      ios: { shadowColor: '#FFD700', shadowOffset: { width: 0, height: 0 }, shadowOpacity: 0.9, shadowRadius: 50 },
  ...
  particle: {
    ...
    ...Platform.select({ ios: { shadowColor: '#FFD700', shadowOffset: { width: 0, height: 0 }, shadowOpacity: 0.8, shadowRadius: 10 }, android: { elevation: 15 } }),
  },
  logoContainer: {
    justifyContent: 'center',
    alignItems: 'center',
    ...Platform.select({ ios: { shadowColor: '#FFD700', shadowOffset: { width: 0, height: 0 }, shadowOpacity: 0.8, shadowRadius: 20 }, android: { elevation: 25 } }),
  },
  ...
  indicatorContainer: { position: 'absolute', bottom: height * 0.1, justifyContent: 'center', alignItems: 'center' },
});
